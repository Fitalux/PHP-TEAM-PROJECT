<?php
    ...
    $sql = "SELECT * FROM Fixedtable WHERE FixedID = 5";
            ...
            <div id="nutcontents">
                <div class="nutimg">
                    <form action="#" method="post">
                        <img src="../assets/img/heodak_sauce_red_cream.jpg" alt="#">
                        <p>가격 : <?=$FixedPrice?>원</p>
                        <button type="submit" name="pickButton0" id="like-button" value="4">Pick!</button>
                    </form>
                </div>
                <div class="nutinfo">
            ...
            <div class="nutsubcontentbox">
                ...
                <div id="nutsubcontents1">
                    ...
                    <div class="nutreviewbox">
                        <div class="nutreview">
                            <div class="reviewimg"><img src="../assets/img/cream2 1.svg" alt=""></div>
                        ...
                        <div class="nutreview">
                            <div class="reviewimg"><img src="../assets/img/cream1 1.svg" alt=""></div>
                            <div class="nutreviewmore">
                                <div class="reviewmorehead">
                                    <h3>만족스럽습니다</h3>
                                    <a href="#">더보기▶</a>
