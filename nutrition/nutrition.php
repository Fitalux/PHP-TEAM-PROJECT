            ...
            <div id="nutcontents">
                <div class="nutimg">
                    <form action="#" method="post">
                        <img src="../assets/img/heodak_sauce_fire.jpg" alt="#">
                        <p>가격 : <?=$FixedPrice?>원</p>
                        <button type="submit" name="pickButton0" id="like-button" value="2">Pick!</button>
                    </form>
                </div>
                <div class="nutinfo">
                    ...
                    <div class="nutinfo1">
                        <h2>제품 원재료명 표기 정보</h2>
                        <p>제품에 표기된 ‘영양성분표’와 ”원재료명’에 들어간 정보는 차이가 있을 수 있습니다.<br>
            ...
            <div class="nutsubcontentbox">
                ...
                <div id="nutsubcontents1">
                    ...
                    <div class="nutreviewbox">
                        <div class="nutreview">
                            <div class="reviewimg"><img src="../assets/img/fire1 1.svg" alt=""></div>
                        ...
                        <div class="nutreview">
                            <div class="reviewimg"><img src="../assets/img/fire2 1.svg" alt=""></div>
                            <div class="nutreviewmore">
                                <div class="reviewmorehead">
                                    <h3>아주 좋아요!</h3>
                                    <a href="#">더보기▶</a>
                        ...
                        <div class="nutreview">
                            <div class="reviewimg"><img src="../assets/img/fire3 1.svg" alt=""></div>
                            <div class="nutreviewmore">
                                <div class="reviewmorehead">
                                    <h3>취향저격!</h3>
                                    <a href="#">더보기▶</a>
                        ...
                        <div class="nutreview">
                            <div class="reviewimg"><img src="../assets/img/fire4 1.svg" alt=""></div>
                            <div class="nutreviewmore">
                                <div class="reviewmorehead">
                                    <h3>항상 채워놓습니다</h3>
                                    <a href="#">더보기▶</a>
