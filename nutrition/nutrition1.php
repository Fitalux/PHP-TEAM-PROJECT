<?php
    ...
    $sql = "SELECT * FROM Fixedtable WHERE FixedID = 2";
            ...
            <div id="nutcontents">
                <div class="nutimg">
                    <form action="#" method="post">
                        <img src="../assets/img/heodak_sauce_gal_b.jpg" alt="#">
                        <p>가격 : <?=$FixedPrice?>원</p>
                        <button type="submit" name="pickButton0" id="like-button" value="3">Pick!</button>
                    </form>
                </div>
                <div class="nutinfo">
