        ...
        <div class="intro__inner">
            <?php
                ...
                if($isEmailCheck == true && $isPhoneCheck = true){
                    // 데이터 입력하기
                    $sql = "INSERT INTO yungyangMember(youEmail, youID, youName, youPass, youPhone, regTime) 
                    VALUES('$youEmail', '$youID', '$youName', '$youPass', '$youPhone', '$regTime')";
                    $result = $connect -> query($sql);

                    if($result){
                        HEADER("Location: joinEnd.php");
                        exit;
                    } else {
